...
表面上的「正道」未必真正光明——百年名門可能深藏偽善、鎮派絕學或許來歷不正、德高望重的長老背後可能血債累累。邪道亦有其信念與情義。讓每個勢力都有值得懷疑或同情的一面，沒有絕對的善惡過於分明。
  ...
  "factions": [
    {
      ...
      "secret": "不為外人所知的秘密或陰暗面（無則填空字串）"
    }
  ],
  "tensions": [
    { "parties": ["勢力A", "勢力B"], "reason": "具體恩怨或利益衝突" }
  ],
...
4. 主角與當前江湖核心矛盾或某個勢力恩怨的具體聯繫——可以利用上方的門派秘密製造更深的劇情張力。
