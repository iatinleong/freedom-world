...
・深層（20%）：（黑神話悟空）埋一兩個歷史謊言——某個眾人景仰的英雄，當年的「義舉」其實是一場掩蓋；某門派的立派根基，是百年前一場不為人知的背叛；掌門知道，弟子不知道
・暗線（20%）：（道詭異仙）一處讓人細思恐極的細節——某個一直存在的習俗、禁忌或傳說，細想之下竟讓人後背發涼

【勢力與格局】
本局登場的勢力為：${selectedFactions}。
大多數勢力有清晰的立場與個性。少數（1-2個）有深埋的歷史秘密。
正邪的模糊感來自「同一個歷史真相，各方有不同的詮釋與掩蓋」——不是同一件物品同時屬於六個門派，而是同一場百年前的事件，每個門派都只說對自己有利的那一半。
例如：某正派的鎮派絕學與某邪派的秘典同宗同源，分流點是百年前一場宗門內鬥；正派說「我們淨化了邪功」，邪派說「他們偷走了我們的傳承」——兩邊說的都是真的。
...
主調是金庸式的俠義恩仇，但在字裡行間自然埋下一兩處伏筆，讓細心的讀者隱隱覺得這個江湖「有什麼地方不太對」。
