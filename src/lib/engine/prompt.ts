...
・計算過程與數值結果只填入 stateUpdate.hpChange，絕對不可出現於 narrative
【內功——輔助心法】不直接傷害，而是：
